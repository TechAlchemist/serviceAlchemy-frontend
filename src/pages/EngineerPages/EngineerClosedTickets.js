...
import { getEngineersClosedTickets } from '../../services/ticketService';
...
const EngineerOpenTicketsPage = (props) => {
    ...
    async function getOpenTickets() {
        const ticketData = await getEngineersClosedTickets(props.user._id);
    ...
    return (
        <div className="container-fluid">
            ...
            <div className="row">   
            <EngineerSideBar active={'engineersClosedTickets'} />
